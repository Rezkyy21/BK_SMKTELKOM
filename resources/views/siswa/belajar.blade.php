...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="{{ route('siswa.belajar') }}" class="text-blue-600 hover:text-blue-800 font-medium border-b-2 border-blue-600">Belajar</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-white rounded-lg shadow-md p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-4">Materi Belajar</h1>
            <p class="text-gray-600 mb-6">
                Akses berbagai materi pembelajaran yang disediakan oleh guru dan tutor kami untuk mendukung proses belajar Anda.
            </p>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                <div class="bg-gradient-to-br from-orange-100 to-orange-50 rounded-lg p-6 border border-orange-200">
                    <h3 class="text-lg font-semibold text-orange-900 mb-2">Materi Akademik</h3>
                    <p class="text-orange-700 text-sm">Dapatkan akses ke materi pembelajaran yang komprehensif untuk semua mata pelajaran.</p>
                </div>
                <div class="bg-gradient-to-br from-cyan-100 to-cyan-50 rounded-lg p-6 border border-cyan-200">
                    <h3 class="text-lg font-semibold text-cyan-900 mb-2">Video Tutorial</h3>
                    <p class="text-cyan-700 text-sm">Tonton video tutorial dari guru berpengalaman untuk memahami materi dengan lebih mudah.</p>
                </div>
                <div class="bg-gradient-to-br from-lime-100 to-lime-50 rounded-lg p-6 border border-lime-200">
                    <h3 class="text-lg font-semibold text-lime-900 mb-2">Latihan Soal</h3>
                    <p class="text-lime-700 text-sm">Kerjakan berbagai latihan soal untuk menguji pemahaman dan persiapan ujian Anda.</p>
                </div>
            </div>
            
            @if(isset($materis) && $materis->isNotEmpty())
                <div class="mt-8">
                    <h2 class="text-2xl font-semibold mb-4">Daftar Materi</h2>
            ...
            @else
                <div class="mt-8 text-gray-600">Belum ada materi yang dipublikasikan di kategori ini.</div>
            @endif
        </div>
    </div>
</body>
